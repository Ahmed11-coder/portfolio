    ...
    return (
        <svg width="600 " height="600" viewBox="0 0 700 510" fill="none" xmlns="http://www.w3.org/2000/svg" className='absolute z-1 bottom-0 left-0 h-full'>
            <g filter="url(#filter0_f_106_583)">
                <path d="M170.383 410.552C164.887 247.143 41.4336 142.368 -13 121V793H488C410.313 757.689 177.253 614.814 170.383 410.552Z" fill="url(#paint0_radial_106_583)"/>
            </g>
            <defs>
                ...
                <radialGradient id="paint0_radial_106_583" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" className='animated-gradient' gradientTransform="translate(227.5 478.5) rotate(129.596) scale(262.797 185.535)">
